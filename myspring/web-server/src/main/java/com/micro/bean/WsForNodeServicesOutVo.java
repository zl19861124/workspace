...
@XmlRootElement(namespace = "http://www.micro.com/ws/demo", name = "wsForNodeServicesResponse")
@XmlAccessorType(XmlAccessType.FIELD)
public class WsForNodeServicesOutVo {

    @XmlElement(name = "wsForNodeServices", required = true)
    protected WsForNodeServices wsForNodeServices;
